  ...
  _buildKBTowers() {
    const towers = [
      ...
      // ── Map 2: Desert towers ─────────────────────────────────────────────────
      {
        ...
        paths: {
          A: { name: 'Адский огонь',  desc: 'Урон +50% · Ожог 5% HP/сек · До 7% в финале' },
          B: { name: 'Смоляной',      desc: 'Радиус +50% · Ожог 7–10 сек · Долгое горение' }
        },
      ...
      },
      {
        ...
        paths: {
          A: { name: 'Требушет',  desc: 'Урон +60% · Радиус +40% · Максимальный урон одной цели' },
          B: { name: 'Шрапнель',  desc: 'Площадь +60% · Скорость +40% · Максимальный охват' }
        },
      ...
      },
      {
        ...
        paths: {
          A: { name: 'Королевский',   desc: 'Макс. стаков до 10 · Урон стака до 4% · Для боссов' },
          B: { name: 'Парализующий',  desc: 'Урон +50% · Радиус +40% · Быстрее накапливает стаки' }
        },
      ...
      },
      {
        ...
        stats: [['Тип','Аура (постоянно)'],['Замедление','35%'],['Урон','2% maxHP/сек всем в радиусе']],
        effective: 'Поддержка всех наземных башен в зоне — двойная роль',
        paths: {
          A: { name: 'Буря',       desc: 'Урон до 6% HP/сек · Радиус +40% — для массового урона' },
          B: { name: 'Пескоструй', desc: 'Замедление до 75% · Радиус +50% — для контроля скорости' }
        },
      ...
      },
      {
        ...
        stats: [['Урон','35'],['Радиус','3'],['Блок','Останавливает всех врагов в радиусе на 3 сек']],
        effective: 'Замедление атаки волны — даёт другим башням время добить цель',
        paths: {
          A: { name: 'Фараон',  desc: 'Урон +70% · Блок до 8 сек · Разрушительная атака' },
          B: { name: 'Двойник', desc: 'Радиус +50% · Урон +50% · Широкий контроль области' }
        },
      ...
      },
      {
        ...
        paths: {
          A: { name: 'Древнее проклятие', desc: 'Урон +100% · Проклятие до 22 сек · Мощный дебафф' },
          B: { name: 'Цепное проклятие',  desc: 'Радиус +50% · Урон ×2.5 — широкий охват врагов' }
        },
      ...
      },
      {
        ...
        paths: {
          A: { name: 'Кобра',  desc: 'Яд до 8%/сек · Змея 20 клеток · Летальный яд' },
          B: { name: 'Гнездо', desc: 'До 5 змей · Яд 6%/сек · Покрывает весь путь' }
        },
        legendary: { name: 'Взрыв яда', desc: 'Змеи взрываются ядом (4%/сек, радиус 1.5 кл.) при смерти врага' }
      },
      {
        name: 'Соколятник', color: '#8B5E3C', cost: 175, tax: 4, unlock: 'С волны 4', map: '🏜 Пустыня руин',
        stats: [['Урон','25'],['Радиус','5'],['Цель','Только воздушные']],
        effective: 'Дрон (вол.4), Грифон (вол.8), Воздушный дракон (вол.14)',
        paths: {
          A: { name: 'Орёл',  desc: 'Урон +60% · Радиус +50% — мощная одиночная атака' },
          B: { name: 'Стая',  desc: 'Скорострельность +40% · Радиус +50% — частые удары' }
        },
        legendary: { name: 'Тройной охват', desc: 'Сокол атакует сразу 3 воздушных врага одновременно' }
      },
      {
        ...
        paths: {
          A: { name: 'Солнечная пушка',  desc: 'Урон +50% · Без снижения по цепи · Максимальный урон' },
          B: { name: 'Рассеянный свет',  desc: 'Радиус +60% · Урон +50% — охватывает весь путь' }
        },
